...
import Models.Weapons.Projectiles.DummyBulletP;
...
public class MenuDummyP extends Enemy 
{
	Vector2 aim;
	private boolean wait;
	
	public MenuDummyP(Vector2 position, int AI)
	{
...

	{
		...
		if(loaded)
		{
			world.actors.get(0).add(new DummyBulletP(new Vector2(centerLocation.x,centerLocation.y+25),25,25,25,25));
