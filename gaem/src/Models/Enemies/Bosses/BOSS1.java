...
public class BOSS1 extends Enemy
{
	...
	public BOSS1(Vector2 position, float width, float height, float hitX, float hitY) 
	{
		...
		if(y == 0)
		{
			subObjects.add(new BOSS1turret(new Vector2(0,0), 120, 120, 0, 0, this));
		}
		if(y == 1)
		{
			subObjects.add(new BOSS1turretB(new Vector2(0,0), 120, 120, 0, 0, this));
		}

		subObjects.add(new BOSS1L(new Vector2(143,-3), 150, 300, 140, 290, this));
		subObjects.add(new BOSS1R(new Vector2(-143,-3), 150, 300, 140, 290, this));
		score = 10000;
	}
