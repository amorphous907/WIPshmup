...
public class LeechBullet extends MoveableEntity
{
	public boolean explode = false;

	public LeechBullet(Vector2 position, Vector2 velocity){
	...
	public void collidesWith(MoveableEntity e, World world)
	{
		...
		{
			e.damage(12);
			world.actors.get(0).add(new medi_pellet(centerLocation,20,20,20,20));
			explode = true;
			//kill itself
			remove = true;
		}
