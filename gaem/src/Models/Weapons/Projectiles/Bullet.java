...
public class Bullet extends MoveableEntity
{
	...
	public Bullet(Vector2 position, float width, float height, float hitX,
			float hitY) {
		super(position, width, height, hitX, hitY);
		velocity = new Vector2(0,-900);//how to change its velocity(pixels per second), add this for every bullet for specific velocities
