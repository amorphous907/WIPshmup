...
import Models.Weapons.Projectiles.wideBullet;
import View.World;
...
public class SpreadDEF extends Gun{
	...
	protected void fire(World world, MoveableEntity entity){
		...
		projectiles.add(new wideBullet(new Vector2(entity.centerLocation.x+12, entity.centerLocation.y), new Vector2(0,-900)));
		projectiles.add(new wideBullet(new Vector2(entity.centerLocation.x, entity.centerLocation.y-6), new Vector2(0,-900)));
		projectiles.add(new wideBullet(new Vector2(entity.centerLocation.x-12, entity.centerLocation.y), new Vector2(0,-900)));
